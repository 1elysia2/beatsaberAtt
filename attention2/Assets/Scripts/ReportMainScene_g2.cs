...
public class ReportMainScene_g2 : MonoBehaviour
{
    ...
    void OnEnable()
    {
        ...
        foreach (var v in AttentionReport_g2.allReports)
        {
            var temp = v;
            ...
            b.GetComponent<Button>().onClick.AddListener(() =>
            {
                ...
                for (int i = 0; i < temp.stamps.Count; i++)
                {
                    ...
                    stampBtn.GetComponent<Button>().onClick.AddListener(() =>
                    {
                        ...
                        string reactionStr = $"平均反应时间:{tempStamp.avgReactionTime}";
