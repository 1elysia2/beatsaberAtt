...
public class AttentionStats_g2 : MonoBehaviour
{
    public static AttentionStats_g2 Instance;

    public int totalNotes;
    public int hitCount;
    public int missCount;
    public int badCount;
    public float reactionTimeTotal;
    [Header("�Ƿ���Ҫ������ٻ��������")]
...
reactionTimeTotal= 0;
    ...
    public void RecordHit(Judgment judgment,float reactionTime)
    {
        totalNotes++;
        hitCount++;
    ...
    public void SavetoCSV(string freStr,string ratingStr)
    {
        ...
        loginManager.WriteCSVLine(new string[] { "MaxCombe", maxCombo.ToString() });
         loginManager.WriteCSVLine(new string[] { "ReactionTime", (reactionTimeTotal/hitCount).ToString() });
        ...
        loginManager.WriteCSVLine(new string[] { "d-prime",AttentionReport_g2.DprimeScore().ToShortString()});
